...
smoke:
	...
	$(VERILATOR) --binary --sv --timing --assert -Wall -Wno-fatal -Wno-SYNCASYNCNET --top-module tb_axi_smoke --Mdir build/obj_axi rtl/axi4_lite_memory_slave.sv tb/assertions/axi_sva.sv tb/smoke/tb_axi_smoke.sv
	bash -o pipefail -c './build/obj_axi/Vtb_axi_smoke | tee results_smoke.log'
clean:
